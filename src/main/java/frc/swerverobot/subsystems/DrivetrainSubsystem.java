...
import static frc.swerverobot.Constants.*;
...
public class DrivetrainSubsystem extends SubsystemBase implements UpdateManager.Updatable {
    ...
    private static final double TRACKWIDTH = 1;
    private static final double WHEELBASE = 1;
    ...
    private static final PidConstants rotation2 = new PidConstants(.5, 0.0, 0.0001);
